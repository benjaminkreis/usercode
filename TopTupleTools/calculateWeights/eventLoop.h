...
// Wed Apr 28 11:00:45 2010 by ROOT version 5.22/00d
// from TTree tree/tree
// found on file: /cu1/joshmt/toptuplePAT/flattrees/QCD_Pt1400/Ntuple_QCD_Pt1400_1_1.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           numEle;
   Float_t         eleE[1];   //[numEle]
   Float_t         eleET[1];   //[numEle]
   Float_t         elePX[1];   //[numEle]
   Float_t         elePY[1];   //[numEle]
   Float_t         elePZ[1];   //[numEle]
   Float_t         elePhi[1];   //[numEle]
   Float_t         eleTheta[1];   //[numEle]
   Float_t         eleEta[1];   //[numEle]
   Int_t           eleCharge[1];   //[numEle]
   Int_t           eleIDQuality[1];   //[numEle]
   Float_t         eleTrackPt[1];   //[numEle]
   Float_t         eleTrackPhi[1];   //[numEle]
   Float_t         eleTrackEta[1];   //[numEle]
   Float_t         eleTrackChi2[1];   //[numEle]
   Float_t         eleTrackNDOF[1];   //[numEle]
   Float_t         eleTrackD0[1];   //[numEle]
   Float_t         eleBeamSpotCorrectedTrackD0[1];   //[numEle]
   Float_t         eleTrackDz[1];   //[numEle]
   Float_t         eleSCEta[1];   //[numEle]
   Float_t         eleSCE[1];   //[numEle]
   Float_t         eleSCPhi[1];   //[numEle]
   Float_t         eleSCSigmaEtaEta[1];   //[numEle]
   Float_t         eleSCSigmaIEtaIEta[1];   //[numEle]
   Float_t         eleSCE1x5[1];   //[numEle]
   Float_t         eleSCE5x5[1];   //[numEle]
   Float_t         eleSCE2x5max[1];   //[numEle]
   Float_t         eleTrackIso[1];   //[numEle]
   Float_t         eleEcalIso[1];   //[numEle]
   Float_t         eledr04EcalRecHitSumEt[1];   //[numEle]
   Float_t         eledr03EcalRecHitSumEt[1];   //[numEle]
   Float_t         eleHcalIso[1];   //[numEle]
   Float_t         eleEcalIsoDeposit[1];   //[numEle]
   Float_t         eleHcalIsoDeposit[1];   //[numEle]
   Float_t         eleComRelIso[1];   //[numEle]
   Int_t           elePhotonConversionTag[1];   //[numEle]
   Float_t         elePhotonConversionDist[1];   //[numEle]
   Float_t         elePhotonConversionDcot[1];   //[numEle]
   Float_t         eleTriggerMatch[1];   //[numEle]
   Float_t         eleJetOverlap[1];   //[numEle]
   Float_t         genEleET[1];   //[numEle]
   Float_t         genElePX[1];   //[numEle]
   Float_t         genElePY[1];   //[numEle]
   Float_t         genElePZ[1];   //[numEle]
   Float_t         genElePhi[1];   //[numEle]
   Float_t         genEleTheta[1];   //[numEle]
   Float_t         genEleEta[1];   //[numEle]
   Int_t           genEleCharge[1];   //[numEle]
   Int_t           numMuo;
   Float_t         muoE[1];   //[numMuo]
   Float_t         muoET[1];   //[numMuo]
   Float_t         muoPt[1];   //[numMuo]
   Float_t         muoPX[1];   //[numMuo]
   Float_t         muoPY[1];   //[numMuo]
   Float_t         muoPZ[1];   //[numMuo]
   Float_t         muoPhi[1];   //[numMuo]
   Float_t         muoTheta[1];   //[numMuo]
   Float_t         muoEta[1];   //[numMuo]
   Int_t           muoCharge[1];   //[numMuo]
   Float_t         muonChi2[1];   //[numMuo]
   Float_t         muonD0[1];   //[numMuo]
   Float_t         muonBeamSpotCorrectedD0[1];   //[numMuo]
   Int_t           muonTrackNHits[1];   //[numMuo]
   Float_t         muonNDOF[1];   //[numMuo]
   Float_t         muonTrackIso[1];   //[numMuo]
   Float_t         muonEcalIso[1];   //[numMuo]
   Float_t         muonHcalIso[1];   //[numMuo]
   Float_t         muonComRelIso[1];   //[numMuo]
   Float_t         genMuoET[1];   //[numMuo]
   Float_t         genMuoPX[1];   //[numMuo]
   Float_t         genMuoPY[1];   //[numMuo]
   Float_t         genMuoPZ[1];   //[numMuo]
   Float_t         genMuoPhi[1];   //[numMuo]
   Float_t         genMuoTheta[1];   //[numMuo]
   Float_t         genMuoEta[1];   //[numMuo]
   Int_t           genMuoCharge[1];   //[numMuo]
   Int_t           nT;
   Int_t           nThadronic;
   Float_t         T_hadronicMCTruthE[1];   //[nThadronic]
   Float_t         T_hadronicMCTruthEt[1];   //[nThadronic]
   Float_t         T_hadronicMCTruthPx[1];   //[nThadronic]
   Float_t         T_hadronicMCTruthPy[1];   //[nThadronic]
   Float_t         T_hadronicMCTruthPz[1];   //[nThadronic]
   Int_t           T_hadronicMCMotherIndex[1];   //[nThadronic]
   Int_t           nTleptonic;
   Float_t         T_leptonicMCTruthE[1];   //[nTleptonic]
   Float_t         T_leptonicMCTruthEt[1];   //[nTleptonic]
   Float_t         T_leptonicMCTruthPx[1];   //[nTleptonic]
   Float_t         T_leptonicMCTruthPy[1];   //[nTleptonic]
   Float_t         T_leptonicMCTruthPz[1];   //[nTleptonic]
   Int_t           T_leptonicMCMotherIndex[1];   //[nTleptonic]
   Int_t           nb;
   Float_t         bMCTruthE[1];   //[nb]
   Float_t         bMCTruthEt[1];   //[nb]
   Float_t         bMCTruthPx[1];   //[nb]
   Float_t         bMCTruthPy[1];   //[nb]
   Float_t         bMCTruthPz[1];   //[nb]
   Int_t           bMCTruthMother[1];   //[nb]
   Int_t           nWhadronic;
   Float_t         W_hadronicMCTruthE[1];   //[nWhadronic]
   Float_t         W_hadronicMCTruthEt[1];   //[nWhadronic]
   Float_t         W_hadronicMCTruthPx[1];   //[nWhadronic]
   Float_t         W_hadronicMCTruthPy[1];   //[nWhadronic]
   Float_t         W_hadronicMCTruthPz[1];   //[nWhadronic]
   Int_t           W_hadronicMCTruthPID[1];   //[nWhadronic]
   Int_t           W_hadronicMCTruthMother[1];   //[nWhadronic]
   Int_t           nWleptonic;
   Float_t         W_leptonicMCTruthE[1];   //[nWleptonic]
   Float_t         W_leptonicMCTruthEt[1];   //[nWleptonic]
   Float_t         W_leptonicMCTruthPx[1];   //[nWleptonic]
   Float_t         W_leptonicMCTruthPy[1];   //[nWleptonic]
   Float_t         W_leptonicMCTruthPz[1];   //[nWleptonic]
   Int_t           W_leptonicMCTruthPID[1];   //[nWleptonic]
   Int_t           W_leptonicMCTruthMother[1];   //[nWleptonic]
   Int_t           isElePlusJets;
   Int_t           VQQBosonAbsId;
   Int_t           numJet;
   Float_t         jetE[14];   //[numJet]
   Float_t         jetEt[14];   //[numJet]
   Float_t         jetPt[14];   //[numJet]
   Float_t         jetCorEt[14];   //[numJet]
   Float_t         jetEta[14];   //[numJet]
   Float_t         jetTheta[14];   //[numJet]
   Float_t         jetPhi[14];   //[numJet]
   Float_t         jetPx[14];   //[numJet]
   Float_t         jetPy[14];   //[numJet]
   Float_t         jetPz[14];   //[numJet]
   Int_t           jetNtracksInJet[14];   //[numJet]
   Float_t         jetJetCharge[14];   //[numJet]
   Float_t         jetMuEnergy[14];   //[numJet]
   Float_t         jetMuEnergyFraction[14];   //[numJet]
   Float_t         jetChargedMultiplicity[14];   //[numJet]
   Float_t         jetNeutralHadEnergy[14];   //[numJet]
   Float_t         jetEMEnergyInEB[14];   //[numJet]
   Float_t         jetEMEnergyInEE[14];   //[numJet]
   Float_t         jetEMEnergyFraction[14];   //[numJet]
   Float_t         jetEMEnergyInHF[14];   //[numJet]
   Float_t         jetHadEnergyInHB[14];   //[numJet]
   Float_t         jetHadEnergyInHE[14];   //[numJet]
   Float_t         jetHadEnergyInHF[14];   //[numJet]
   Float_t         jetHadEnergyInHO[14];   //[numJet]
   Float_t         jetBtagTrackCountHighPurity[14];   //[numJet]
   Float_t         jetBtagTrackCountHighEff[14];   //[numJet]
   Float_t         jetBtagProbability[14];   //[numJet]
   Float_t         jetBtagSoftElectron[14];   //[numJet]
   Float_t         jetBtagSoftMuon[14];   //[numJet]
   Float_t         jetBtagSoftMuonNoIP[14];   //[numJet]
   Float_t         jetBtagSoftMuonPtRel[14];   //[numJet]
   Float_t         jetBtagSoftMuonQuality[14];   //[numJet]
   Float_t         jetBtagSecondaryVertex[14];   //[numJet]
   Float_t         jetBtagSecondaryVertexNegative[14];   //[numJet]
   Float_t         jetBtagCombinedSVLL[14];   //[numJet]
   Float_t         jetBtagCombinedSVMVA[14];   //[numJet]
   Float_t         jetCorrFactor[14];   //[numJet]
   Float_t         jetN60[14];   //[numJet]
   Float_t         jetN90[14];   //[numJet]
   Float_t         jetNeutralEmEnergy[14];   //[numJet]
   Float_t         jetTriggered[14];   //[numJet]
   Float_t         jetSVPT[14];   //[numJet]
   Float_t         jetSVL2D[14];   //[numJet]
   Float_t         jetSVL2Dxy[14];   //[numJet]
   Float_t         jetSVL2DxyErr[14];   //[numJet]
   Float_t         jetSVL2DxySig[14];   //[numJet]
   Float_t         jetSVL3D[14];   //[numJet]
   Float_t         jetSVL3DErr[14];   //[numJet]
   Float_t         jetSVL3DSig[14];   //[numJet]
   Float_t         jetSVMass[14];   //[numJet]
   Int_t           jetSVNtracks[14];   //[numJet]
   Float_t         genJetET[14];   //[numJet]
   Float_t         genJetPX[14];   //[numJet]
   Float_t         genJetPY[14];   //[numJet]
   Float_t         genJetPZ[14];   //[numJet]
   Float_t         genJetPhi[14];   //[numJet]
   Float_t         genJetTheta[14];   //[numJet]
   Float_t         genJetEta[14];   //[numJet]
   Int_t           genJetPID[14];   //[numJet]
   Int_t           jetPID[14];   //[numJet]
   Float_t         jetClosestBPartonDeltaR[14];   //[numJet]
   Float_t         jetClosestCPartonDeltaR[14];   //[numJet]
   ...
   Float_t         jetBtagParam_MISTAGSSVM_BTAGLEFF[14];   //[numJet]
   Float_t         jetBtagParam_MISTAGSSVM_BTAGLERR[14];   //[numJet]
   Float_t         jetBtagParam_MISTAGSSVM_BTAGLEFFCORR[14];   //[numJet]
   Float_t         jetBtagParam_MISTAGSSVM_BTAGLERRCORR[14];   //[numJet]
   Float_t         jetBtagParam_PTRELSSVM_BTAGBEFFCORR[14];   //[numJet]
   Float_t         jetBtagParam_PTRELSSVM_BTAGBERRCORR[14];   //[numJet]
   Float_t         jetBtagParam_SYSTEM8SSVM_BTAGBEFF[14];   //[numJet]
   Float_t         jetBtagParam_SYSTEM8SSVM_BTAGBERR[14];   //[numJet]
   Float_t         jetBtagParam_PTRELTCHEL_BTAGBEFFCORR[14];   //[numJet]
   Float_t         jetBtagParam_PTRELTCHEM_BTAGBEFFCORR[14];   //[numJet]
   Float_t         jetBtagParam_PTRELTCHET_BTAGBEFFCORR[14];   //[numJet]
   Float_t         jetBtagParam_PTRELTCHPL_BTAGBEFFCORR[14];   //[numJet]
   Float_t         jetBtagParam_PTRELTCHPM_BTAGBEFFCORR[14];   //[numJet]
   Float_t         jetBtagParam_PTRELTCHPT_BTAGBEFFCORR[14];   //[numJet]
   Int_t           numGeneralTracks;
   Float_t         generalTracksPt[500];   //[numGeneralTracks]
   Float_t         generalTracksEta[500];   //[numGeneralTracks]
   Float_t         generalTracksTheta[500];   //[numGeneralTracks]
   Float_t         generalTracksBeamSpotCorrectedD0[500];   //[numGeneralTracks]
   Float_t         generalTracksPhi[500];   //[numGeneralTracks]
   Int_t           generalTracksCharge[500];   //[numGeneralTracks]
   Int_t           processId;
   ...
   Float_t         mhtSignif;
   Int_t           nZCandidates;
   Float_t         ZCandidates[1];   //[nZCandidates]
   Int_t           nTriggerBits;
   Int_t           TriggerBits[100];   //[nTriggerBits]
   ...
   Int_t           genCharge[2][2];
   Int_t           numTau;
   Float_t         tauE[3];   //[numTau]
   Float_t         tauPt[3];   //[numTau]
   Float_t         tauPhi[3];   //[numTau]
   Float_t         tauEta[3];   //[numTau]
   Int_t           numPhoton;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/cu1/joshmt/toptuplePAT/flattrees/QCD_Pt1400/Ntuple_QCD_Pt1400_1_1.root");
      if (!f) {
         f = new TFile("/cu1/joshmt/toptuplePAT/flattrees/QCD_Pt1400/Ntuple_QCD_Pt1400_1_1.root");
         f->cd("/cu1/joshmt/toptuplePAT/flattrees/QCD_Pt1400/Ntuple_QCD_Pt1400_1_1.root:/makeTopologyNtuple");
      }
