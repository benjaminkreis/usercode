...
//+++MAIN FUNCTION+++//
void eventLoop(TString reqNumBTags = ""){

  cout << "reqNumBTags is " << reqNumBTags << endl;
  
  assert( (reqNumBTags == "nBTagsLT2") || (reqNumBTags == "nBTagsEQ2") || (reqNumBTags == "nBTagsGT2"));
